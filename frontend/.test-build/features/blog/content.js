...
exports.blogArticles = void 0;
exports.getBlogArticles = getBlogArticles;
exports.getBlogArticleSlugs = getBlogArticleSlugs;
exports.getArticleBySlug = getArticleBySlug;
exports.formatArticleDate = formatArticleDate;
exports.blogArticles = [
    {
        slug: "pierwsze-warstwy-co-nas-zaskoczylo",
        title: "Pierwsze warstwy: co nas zaskoczyło na starcie",
        description: "Notatka o tym, dlaczego pierwsza warstwa potrafi zdecydować o całym wydruku i jak zaczynamy podchodzić do testów.",
    ...
    },
    {
        ...
        description: "Jak chcemy podchodzić do poziomowania stołu: spokojnie, powtarzalnie i z notatkami zamiast zgadywania.",
    ...
    },
    {
        ...
        description: "PLA wydaje się łatwe, ale już na nim widać wpływ temperatury, chłodzenia, prędkości i przechowywania filamentu.",
...
async function getBlogArticles() {
    ...
    return cmsArticles ?? exports.blogArticles;
}
...
async function fetchCmsBlogArticles() {
    ...
    try {
        ...
        for (let page = 1;; page += 1) {
            ...
            if (!response.ok)
                throw new Error(`CMS returned HTTP ${response.status}`);
            ...
            if (payload.docs.length === 0)
                throw new Error("Invalid CMS pagination");
        }
    }
    catch (error) {
...
function mapCmsPostToArticle(post) {
    if (!isRecord(post)) {
        return null;
    }
    const cmsPost = post;
...
function readCmsSections(value) {
    ...
    for (const section of value) {
        ...
        const paragraphs = Array.isArray(section.paragraphs)
            ? section.paragraphs
                .map((paragraph) => isRecord(paragraph) ? readString(paragraph.text) : "")
                .filter(Boolean)
            : [];
...
function readCmsTakeaways(value) {
    if (!Array.isArray(value)) {
        return [];
    }
    return value
...
function readRelationshipName(value) {
    if (!isRecord(value)) {
        return null;
    }
